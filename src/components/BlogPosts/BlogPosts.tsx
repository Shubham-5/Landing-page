        ...
        <div className='row row-cols-1 row-cols-md-3 g-4 post-entry'>
          <div className='col'>
            <div className='card h-100'>
              ...
              <div className='card-body'>
                ...
                <p>
                  <a href='#' className='d-flex align-items-center read-more'>
                    <span>Read more</span>{" "}
          ...
          <div className='col'>
            <div className='card h-100'>
              <a href='#'>
                <img
                  src='https://untree.co/demos/impact/images/post_3.jpg'
                  className='card-img-top'
                  alt='not found'
                />
              </a>
          ...
          <div className='col'>
            <div className='card h-100'>
              <a href='#'>
                <img
                  src='https://untree.co/demos/impact/images/post_4.jpg'
                  className='card-img-top'
                  alt='not found'
                />
              </a>
